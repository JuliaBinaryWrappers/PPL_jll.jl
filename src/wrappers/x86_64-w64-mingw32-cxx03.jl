# Autogenerated wrapper script for PPL_jll for x86_64-w64-mingw32-cxx03
...
const libppl_splitpath = ["bin", "libppl-14.dll"]
...
const libppl = "libppl-14.dll"


# Relative path to `libppl_c`
const libppl_c_splitpath = ["bin", "libppl_c-4.dll"]
...
# This must be `const` so that we can use it with `ccall()`
const libppl_c = "libppl_c-4.dll"


# Relative path to `ppl_lcdd`
const ppl_lcdd_splitpath = ["bin", "ppl_lcdd.exe"]
...
const ppl_config_splitpath = ["bin", "ppl-config.exe"]
...
const ppl_pips_splitpath = ["bin", "ppl_pips.exe"]
