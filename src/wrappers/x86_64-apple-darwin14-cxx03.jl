# Autogenerated wrapper script for PPL_jll for x86_64-apple-darwin14-cxx03
...
const libppl_splitpath = ["lib", "libppl.14.dylib"]
...
const libppl = "@rpath/libppl.14.dylib"


# Relative path to `libppl_c`
const libppl_c_splitpath = ["lib", "libppl_c.4.dylib"]
...
# This must be `const` so that we can use it with `ccall()`
const libppl_c = "@rpath/libppl_c.4.dylib"
