...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import PPL_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("80dd9cbb-8b87-5171-a280-372cc418f402"))
platforms = [Pkg.Artifacts.unpack_platform(e, "PPL", artifacts_toml) for e in artifacts["PPL"]]
...
if best_platform === nothing
    @debug("Unable to load PPL; unsupported platform $(triplet(platform_key_abi()))")
else
